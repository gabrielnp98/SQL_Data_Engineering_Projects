...
SELECT '=== Loading skills_mart.dim_skills Table ===' AS info;
...
SELECT DISTINCT
    ...
    EXTRACT(YEAR FROM job_posted_date)::VARCHAR || '-' || EXTRACT(QUARTER FROM job_posted_date)::VARCHAR AS year_quarter
...
SELECT '=== Loading skills_mart.fact_skill_demand_monthly Table ===' AS info;
